    ...
    <div class="prototype">
      <div class="div">
        ...
        <div class="overlap-group">
          ...
          <div class="rectangle">
            <center>
            <form action="../CustomerServiceSecondReply/index.php" method="get">
        ...
        <div class="overlap-2">
          ...
          <img class="img" src="img/polygon-4.svg" />
          <p style="margin-top: -30px" class="p"><?php if (isset($userMessage)) echo $userMessage; ?></p>
        </div>

        <div class="overlap-4">
          <div class="rectangle-5"></div>
          <img class="polygon-2" src="img/polygon-2.svg" />
